...
export default function BadRequest() {
    return (
        <>
            <Head title="400 - Permintaan Tidak Valid" />
            <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4">
                <div className="w-full max-w-md text-center">
                    {/* Error Icon */}
                    <div className="mb-6 flex justify-center">
                        <div className="rounded-full bg-[var(--singgah-red-50)] p-6">
                            <XCircle className="h-16 w-16 text-[var(--singgah-red-600)]" />
                        </div>
                    </div>
                    ...
                    <p className="mb-8 text-gray-600">
                        Maaf, permintaan yang Anda kirim tidak dapat diproses
                        oleh server. Pastikan data yang Anda masukkan sudah
                        benar.
                    </p>
