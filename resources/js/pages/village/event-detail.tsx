...
export default function EventDetail({ village, event, reviews, userReview, isWishlisted = false }: Props) {
                    ...
                    <div className="grid gap-10 lg:grid-cols-[2fr_1fr]">
                        <div className="space-y-8">
                            ...
                            {event.media.length > 0 && (
                                <MediaGallery media={event.media} maxVisible={6} />
                            )}
                            ...
                            {event.description && (
                                <div>
                                    ...
                                    <div
                                        className="prose leading-relaxed text-gray-600 max-w-none"
                            ...
                            <div>
                                ...
                                <ReviewForm
                                    reviewableType="village_event"
                                    reviewableId={event.id}
                                    isLoggedIn={isLoggedIn}
